    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
            <a href="{{ route('rentals.create') }}">
                ...
                @else
                    <img class="mx-auto h-full dark:hidden"
                        src="{{ asset('default-product-image.jpg') }}"
        ...
        <div class="pt-6">
            ...
            <p class="text-sm font-semibold leading-tight text-gray-500 hover:underline dark:text-white">
                ...
                <div class="grid grid-cols-1 gap-6" id="filter-options" role="tabpanel">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center pb-2">
                                <input id="unavailable" name="status" type="radio" value="1"
                    ...
                    <!-- Submit Button -->
                    <div class="pt-4">
                        <button type="submit" class="w-full inline-flex justify-center text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-sm">
                            Terapkan Filter
                        </button>
                    </div>
                </div>
