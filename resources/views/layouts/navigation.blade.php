<nav x-data="{
    ...
    getProfileImageInitial() {
        @if(Auth::check())
            ...
            if (userName.startsWith('Admin')) {
                ...
                return 'U';
            } else if (userName.startsWith('Aku User')) {
                return 'AU';
            } else {
                return userName.charAt(0);
            }
        @else
            return 'G'; // Default for guests
        @endif
    },
    getProfileColor() {
        @if(Auth::check())
        ...
        @else
            return 'bg-gray-400'; // Default for guests
        @endif
    }
}"
        ...
        <ul class="hidden items-center gap-4 flex-shrink-0 sm:flex">
            <li><a href="{{ url('dashboard') }}"
                    :class="isActive('/dashboard') ?
                        ...
                        'font-medium text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
            ...
            <li><a href="{{ url('product') }}"
                    :class="isActive('/product') ?
                        ...
                        'font-medium text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/product') ? 'page' : null">Produk</a>
            </li>
            <li><a href="{{ url('show') }}"
                    :class="isActive('/show') ?
                        'font-bold text-blue-500' :
                        'font-medium text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/show') ? 'page' : null">Pesanan</a>
            </li>
            <li><a href="{{ url('contact') }}"
                    :class="isActive('/contact') ?
                        ...
                        'font-medium text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/contact') ? 'page' : null">Hubungi</a>
            </li>
            <!-- User Profile -->
            <li x-data="{ userDropDownIsOpen: false, openWithKeyboard: false }" @keydown.esc.window="userDropDownIsOpen = false, openWithKeyboard = false"
                ...
                <button @click="userDropDownIsOpen = ! userDropDownIsOpen" :aria-expanded="userDropDownIsOpen"
                    ...
                    <div :class="getProfileColor()" class="size-8 rounded-full flex items-center justify-center text-white font-bold">
                        <span x-text="getProfileImageInitial()"></span>
                    </div>
                </button>
                <!-- User Dropdown -->
    ...
    @else
        ...
        <ul class="hidden items-center gap-4 flex-shrink-0 sm:flex">
            <li>
                <a href="{{ route('login') }}"
                    class="px-4 py-2 text-sm font-medium text-neutral-600 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
                    Login
                </a>
            </li>
            <li>
                <a href="{{ route('register') }}"
                    class="px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
                    Sign Up
                </a>
            </li>
        </ul>
        ...
        <ul x-cloak x-show="mobileMenuIsOpen"
            ...
            <li class="mb-4 border-none">
                <div class="flex items-center gap-2 py-2">
                    <!-- Mobile menu profile image container -->
                    <div :class="getProfileColor()" class="size-12 rounded-full flex items-center justify-center text-white font-bold text-lg">
                        <span x-text="getProfileImageInitial()"></span>
                    </div>
                    <div>
            ...
            <li class="p-2"><a href="{{ url('dashboard') }}"
                    :class="isActive('/dashboard') ?
                        ...
                        'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/dashboard') ? 'page' : null">Beranda</a>
            </li>
            <li class="p-2"><a href="{{ url('product') }}"
                    :class="isActive('/product') ?
                        ...
                        'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/product') ? 'page' : null"
            ...
            <li class="p-2"><a href="{{ url('show') }}"
                    :class="isActive('/show') ?
                        ...
                        'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                    class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                    :aria-current="isActive('/show') ? 'page' : null"
            ...
            <li class="p-2">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full text-neutral-600 focus:underline dark:text-neutral-300 text-left" role="menuitem">
                        {{ __('Log Out') }}
                    </button>
                </form>
            </li>
    ...
    @else
        ...
        <ul x-cloak x-show="mobileMenuIsOpen"
            ...
            <li class="p-2">
                <a href="{{ route('login') }}"
                    class="block w-full px-4 py-2 text-center text-lg font-medium text-neutral-600 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
                    Login
                </a>
            </li>
            <li class="p-2">
                <a href="{{ route('register') }}"
                    class="block w-full px-4 py-2 text-center text-lg font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
                    Sign Up
                </a>
            </li>
        </ul>
