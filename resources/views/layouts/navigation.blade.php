<div>
        <nav x-data="{ 
            ...
            <ul x-cloak x-show="mobileMenuIsOpen"
                ...
                <li class="p-2"><a href="{{ url('dashboard') }}" :class="isActive('/dashboard') 
                ...
                <li class="p-2"><a href="{{ url('product') }}" :class="isActive('/product') 
                    ? 'font-bold text-blue-500 text-lg' 
                    : 'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                ...
                <li class="p-2"><a href="{{ url('show') }}" :class="isActive('/show') 
                    ? 'font-bold text-blue-500 text-lg' 
                    : 'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
                ...
                <li class="p-2"><a href="{{ url('contact') }}" :class="isActive('/contact') 
                    ? 'font-bold text-blue-500 text-lg' 
                    : 'font-medium text-lg text-neutral-600 dark:text-neutral-300 dark:hover:text-white'"
                class="underline-offset-2 hover:text-black focus:outline-none focus:underline"
