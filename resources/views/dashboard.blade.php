...
<body class="font-jakarta">
    ...
    <div>
        <nav x-data="{ mobileMenuIsOpen: false }" @click.away="mobileMenuIsOpen = false" class="flex items-center justify-between bg-neutral-50 border-b border-neutral-300 gap-4 px-6 py-4 dark:border-neutral-700 dark:bg-neutral-900" aria-label="penguin ui menu">
            ...
            <ul class="hidden items-center gap-4 flex-shrink-0 sm:flex">
                <li><a href="#" class="font-bold text-blue-500 underline-offset-2 hover:text-black focus:outline-none focus:underline dark:text-white dark:hover:text-white" aria-current="page">Beranda</a></li>
    ...
    <div class="bg-white p-14 rounded-lg shadow-lg">
        <h1 class="text-left text-2xl sm:text-4xl md:text-4xl font-jakarta pb-4">
            Selamat Datang {{ Auth::user()->name }}! 👋
        </h1>
        <span></span>
        <p class="mt-4 text-base sm:text-lg md:text-xl">
            Lengkapi Momen Spesial Anda dengan Peralatan Terbaik, Hanya di Ganesha!
        </p>
    </div>
    <div>
        <div x-data="{            
